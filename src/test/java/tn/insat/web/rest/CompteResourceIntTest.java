...
public class CompteResourceIntTest {
    ...
    public void setup() {
        ...
        CompteResource compteResource = new CompteResource(compteRepository);
    ...
    public void createCompte() throws Exception {
        ...
        assertThat(testCompte.getCreationDate()).isEqualTo(DEFAULT_CREATION_DATE);
    }
    ...
    public void updateCompte() throws Exception {
        ...
        assertThat(testCompte.getCreationDate()).isEqualTo(UPDATED_CREATION_DATE);
    }
